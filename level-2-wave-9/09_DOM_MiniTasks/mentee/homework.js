...
console.log(moviesTitleEl, moviesInfoEl, moviesListEl);
...
newMovie.textContent = "MadMax Fury Road";
newMovie.classList.add("movie");
moviesListEl.appendChild(newMovie);

const firstMovie = moviesListEl.children[0];
firstMovie.remove();

const updatedMovieCount = moviesListEl.children.length;
moviesInfoEl.textContent = `You currently have ${movieCount} favorite movies in your list.`;